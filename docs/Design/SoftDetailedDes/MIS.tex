...
according to \tref{TM2} and returns the value \code{logLoss} as $\mathbf{R}$.
\end{itemize}
...
\begin{itemize}
  \item inputImage: The input image as processed and given by \mref{mIDR} as $\mathbf{I}_{x,y}$
