...
% #4 equation
{
  $ L(y,\hat{y}) = -(1 \div n) \cdot \sum_{i = 1}^{n} \[ y_i \cdot \log(\hat{y}_i)\ + (1 - y_i) \cdot \log(1 - \hat{y}_i)\]  $
}
% #5 description
{
...
% #6 Notes
{
The values of $y$ and $\hat{y}$ can be scalar or matrices, but they must be the of the same size (see \dref{A1}).
}
% #7 Source
{
\url{https://towardsdatascience.com/logistic-regression-from-scratch-69db4f587e17}
